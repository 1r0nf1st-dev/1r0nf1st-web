...
export const NoteDetail = ({
  ...
  const [pasteFlushKey, setPasteFlushKey] = useState(0);
      ...
      <div className="note-modal">
        ...
        <div className="note-modal-body">
          <div className="flex flex-col gap-4">
            ...
            {note && onNoteClick && <BacklinksSection noteId={note.id} onNoteClick={onNoteClick} />}
              ...
              {!isNewNote && (
                <>
                  ...
                  <button
                    ...
                    className="act-btn text-red-500 border-red-500/50 hover:border-red-500/70 hover:bg-red-500/10 ml-auto"
                  >
                    Delete
                  </button>
                </>
