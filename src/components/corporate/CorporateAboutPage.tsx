        ...
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-muted mb-8">
              ...
              and activity. Everything is powered by live data from various APIs.
            </p>
            <div className="space-y-6 text-foreground">
              <section>
                <h2 className="text-lg font-semibold mb-2">Tech Stack</h2>
                <p className="text-muted text-sm leading-relaxed">
                  Next.js, React, TypeScript, Express, Tailwind CSS, and Supabase. Notes with
                  TipTap, auth, and contact via Brevo. Deployed on Vercel. Integrates with GitHub,
                  Medium, Dev.to, Spotify, Strava, OpenWeather, and more.
                </p>
              </section>
            </div>
            <Link
